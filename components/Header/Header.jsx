...
export default function Header() {
  ...
  return (
    <header className='w-full h-[110px] bg-white flex items-center justify-between pl-[135px] pr-[135px] shadow-[0px_1px_1px_rgba(0,0,0,0.15)]'>
        <h1><Image src="/Logo.svg" alt="Logo" width={130} height={27.36} priority />
        </h1>
  ...
  <button type="submit" className='absolute right-0 top-0 w-[100px] h-[50px] bg-[#023047] rounded-r-[5px] text-white cursor-pointer hover:bg-[#022048] active:bg-[#023048]'>Search</button>
        ...
        <div className='flex items-center gap-[30px]'>
            <Image src="/Catalog.svg" alt="Catalog" width={25} height={25} className='cursor-pointer' priority ></Image>
            <Image src="/Love.svg" alt="Love" width={26.64} height={25} className='cursor-pointer' priority ></Image>
            <Image src="/Profile.svg" alt="Profile" width={22.67} height={25} className='cursor-pointer' priority ></Image>
